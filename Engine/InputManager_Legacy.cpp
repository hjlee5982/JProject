...
//void InputManager_Legacy::Init(HWND hWnd, HINSTANCE hInst)
//{
//	mhWnd = hWnd;
...
//}
//
//void InputManager_Legacy::Update()
//{
...
bool InputManager_Legacy::KeyUp(DWORD key)
{
	if (_key & key)
	{
		_keyUp |= key;
...
bool InputManager_Legacy::KeyDown(DWORD key)
{
...
bool InputManager_Legacy::KeyPress(DWORD key)
{
	if (_key & key)
	{
		return true;
